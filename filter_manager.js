...
function extractUniqueFilterValues() {
    ...
    console.log('Customer Countries:', uniqueCustomerCountries);
    console.log('Customer Segments:', uniqueCustomerSegments);
}

function populateCustomerCountryOptions() {
    const customerCountrySelect = document.getElementById('customer-country-select');
    if (!customerCountrySelect) {
        console.warn('Customer country select element not found');
        return;
    }

    if (!uniqueCustomerCountries || uniqueCustomerCountries.length === 0) {
        console.warn('No unique customer countries available for population');
        return;
    }
    ...
    console.log('Populated customer country options:', uniqueCustomerCountries.length);
}

function populateCustomerSegmentOptions() {
    const customerSegmentSelect = document.getElementById('customer-segment-select');
    if (!customerSegmentSelect) {
        console.warn('Customer segment select element not found');
        return;
    }

    if (!uniqueCustomerSegments || uniqueCustomerSegments.length === 0) {
        console.warn('No unique customer segments available for population');
        return;
    }
    ...
    console.log('Populated customer segment options:', uniqueCustomerSegments.length);
}
